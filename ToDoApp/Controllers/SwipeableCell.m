...
static CGFloat const kBounceValue = 25.0f;
...
{
    return CGRectGetWidth(self.frame) - CGRectGetMinX(self.editBtn.frame);
}
    ...
    switch (recognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
            if (self.startingRightLayoutConstraintConstant == 0) { //1
                //We were opening
                CGFloat halfOfButtonOne = CGRectGetWidth(self.delBtn.frame) / 2; //2
                ...
                //We were closing
                CGFloat buttonOnePlusHalfOfButton2 = CGRectGetWidth(self.delBtn.frame) + (CGRectGetWidth(self.editBtn.frame) / 2); //4
